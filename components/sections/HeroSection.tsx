    ...
    <section className="relative min-h-screen bg-navy overflow-hidden flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-20 pb-16 sm:pt-28 sm:pb-20 lg:pt-36 lg:pb-24 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            {/* Trust badge */}
            <div className="animate-fade-up inline-flex items-center gap-2.5 bg-white/10 backdrop-blur border border-white/20 text-blue-200 text-xs sm:text-base font-bold px-3 py-2 sm:px-6 sm:py-3 rounded-full mb-6 sm:mb-8">
            ...
            {/* H1 */}
            <h1 className={`animate-fade-up delay-100 font-extrabold text-white tracking-tight mb-6 font-sinhala-body ${si ? 'text-[28px] sm:text-[38px] lg:text-[46px] leading-[1.1]' : 'text-[32px] sm:text-[42px] lg:text-[52px] leading-[1.1]'}`}>
              {si
            ...
            {/* Subtext */}
            <p className="animate-fade-up delay-200 text-blue-200 text-lg leading-relaxed mb-10 max-w-lg font-sinhala-body">
              {si
            ...
            <div className="animate-fade-up delay-300 flex flex-col sm:flex-row gap-4 mb-14">
              <Link
                ...
                className="group flex items-center justify-center gap-2 bg-royal hover:bg-electric text-white font-bold px-8 py-4 rounded-2xl text-base transition-all duration-300 shadow-lg shadow-royal/40 btn-press cursor-pointer font-sinhala-body"
              >
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold px-8 py-4 rounded-2xl text-base transition-all duration-300 cursor-pointer font-sinhala-body shadow-lg shadow-[#25D366]/30"
              >
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4">
              {[
                ...
                <motion.div
                  ...
                  className="text-center p-2 sm:p-4 bg-white/8 backdrop-blur border border-white/15 rounded-2xl cursor-default"
                >
                  <p className="text-2xl font-extrabold text-white">
                    {stat.display ?? <CountUp to={stat.to} suffix={stat.suffix} />}
                  </p>
                  <p className="text-blue-300 text-xs font-medium mt-0.5 font-sinhala-body">{stat.label}</p>
                </motion.div>
              ))}
            </div>
          </div>
          ...
          <div className="animate-fade-right delay-300 relative">
            ...
            <Link href={`/${locale}/liquid-machine`} className="block relative bg-white/8 backdrop-blur-sm border border-white/20 rounded-3xl p-6 shadow-2xl hover:border-white/40 hover:bg-white/12 transition-all duration-300 cursor-pointer">
              <span className="absolute top-5 left-5 z-10 bg-orange text-white text-xs font-bold px-3 py-1.5 rounded-full font-sinhala-body">
              ...
              <Image
                ...
                width={600}
                height={520}
                className="w-full h-[340px] sm:h-[420px] object-contain drop-shadow-2xl animate-float"
                priority
              />
              <p className="text-center text-white font-bold text-base mt-3 tracking-tight font-sinhala-body">
                {si ? 'ස්වයංක්‍රීය ද්‍රව පිරවීම් යන්ත්‍රය' : 'Automatic Liquid Filling & Packing Machine'}
              </p>
              {/* ── Price card ── */}
              <div className="mt-4 relative">
                {/* Floating discount pill */}
                <div className="absolute -top-3.5 left-4 z-10 flex items-center gap-1.5 bg-orange text-white text-[11px] font-extrabold px-3 py-1 rounded-full shadow-lg shadow-orange/50">
                ...
                <div className="bg-navy/80 backdrop-blur rounded-2xl border border-white/10 overflow-hidden">
                  ...
                  <div className="px-5 pt-4 pb-3">
                    ...
                    <div className="flex items-center justify-between mb-1">
                      <p className="text-blue-300 text-[11px] font-medium font-sinhala-body">{si ? 'විශේෂ පූර්ව ඇණවුම් මිල' : 'Special Pre-Order Price'}</p>
                      <p className="text-white/50 text-base font-bold line-through">LKR {FLAGSHIP.priceRegular.toLocaleString('en-LK')}</p>
                    </div>
                    {/* Offer price */}
                    <p className="text-white font-extrabold text-3xl tracking-tight leading-none mb-3">
