...
export default function PreOrderCTA() {
  return (
    <section className="relative bg-gradient-to-r from-navy via-blue-900 to-navy py-10 px-4 overflow-hidden">
      {/* Glow blobs */}
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        <p className="text-blue-300 text-xs font-bold uppercase tracking-[0.25em] mb-4">
          Ready to Order?
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-5 justify-center">
          <a
            ...
            className="flex items-center justify-center gap-3 bg-whatsapp hover:bg-green-400 text-white font-extrabold text-base sm:text-lg px-6 sm:px-10 py-4 sm:py-5 rounded-2xl transition-all btn-press shadow-2xl shadow-whatsapp/40"
          >
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 bg-orange hover:bg-orange-500 text-white font-extrabold text-base sm:text-lg px-6 sm:px-10 py-4 sm:py-5 rounded-2xl transition-all btn-press shadow-2xl shadow-orange/40"
          >
