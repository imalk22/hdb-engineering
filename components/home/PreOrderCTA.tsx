    ...
    <section className="relative bg-gradient-to-r from-navy via-blue-900 to-navy py-10 px-4 overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        ...
        <h2 className="text-5xl sm:text-6xl font-extrabold text-white mb-6 leading-tight">
          Start Your{' '}
          <span className="text-orange">Pre-Order</span>{' '}
          Today
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-5 justify-center">
          <a
            ...
            className="flex items-center justify-center gap-3 bg-whatsapp hover:bg-green-400 text-white font-extrabold text-lg px-10 py-5 rounded-2xl transition-all btn-press shadow-2xl shadow-whatsapp/40"
          >
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 bg-orange hover:bg-orange-500 text-white font-extrabold text-lg px-10 py-5 rounded-2xl transition-all btn-press shadow-2xl shadow-orange/40"
          >
